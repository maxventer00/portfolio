      ...
      <Box maxWidth={["95%", "100%", "100%"]} marginLeft={[1, 2, 2]}>
        <Fade bottom>
          ...
          >
            ...
            crafte beer home brewing. Complex user flows, cart management,
            in-app guided tutorials and smooth fluid designs. Strict Agile/SCRUM
          ...
          <UnorderedList>
            <ListItem
              ...
              fontSize={[14, 18, 18]}
            >
              Began interning to start learning about Javascript/React,
              Initially solving design conformance issues and learning about the
              codestack - Typescript, React, ChakraUI, Java/SOAP backend.
            </ListItem>
            <ListItem
              color="#120e2b"
              letterSpacing={1}
            ...
            >
              ...
              project was coming to a close due to scope-creep/business
              decisions. Working on coding complex user flows and integration
              with our backend as well as third party services and integration
              such as google's location API, google analytics, and Stripes
              payment API
            </ListItem>
          </UnorderedList>
        </Fade>
